        ...
        <div className="flex items-center justify-between relative">
          <div className="flex w-2/5 justify-around">
            <Link
              to="/dashboard"
              className={cn(
                "flex flex-col items-center justify-center gap-1 w-full h-full py-2 touch-manipulation select-none cursor-pointer active:scale-90 transition-transform",
                activeTab === "dashboard"
                  ? "text-emerald-600"
                  : "text-slate-400",
              )}
          ...
          <button
            onClick={triggerAdd}
            className="absolute left-1/2 -top-8 -translate-x-1/2 w-16 h-16 bg-emerald-600 rounded-full flex items-center justify-center text-white shadow-lg shadow-emerald-600/30 border-4 border-slate-50 dark:border-slate-900 z-[60] touch-manipulation select-none cursor-pointer active:scale-90 transition-transform"
          >
            <Plus size={32} />
          </button>
